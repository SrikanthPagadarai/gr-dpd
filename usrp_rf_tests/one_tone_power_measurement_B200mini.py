...
def main(argv):
    ...
    try:
       opts, args = getopt.getopt(argv,"hf:g:a:",["freq=", "gain=", "bb_ampl="])
    except getopt.GetoptError:
       print 'one_tone_power_measurement_B200mini.py -f <center_freq> -g <gain> -a <dac_scale>'
       sys.exit(2)
    ...
    if b200mini_gain < 0.0 or b200mini_gain > 89.8:
       print 'Error! Invalid choice of Tx gain for B200-Mini.'
       sys.exit()
    ...
    dir_name = "./one_tone_power_measurements_B200mini"
    if not os.path.exists(dir_name):
       os.makedirs(dir_name)

    filename = "one_tone_power_B200mini_f" + str(int(center_freq)) + "_g" + str(int(b200mini_gain*10)) + "_a" + str(int(bb_ampl*100)) + ".bin"
